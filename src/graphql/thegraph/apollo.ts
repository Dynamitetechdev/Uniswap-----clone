...
const CHAIN_SUBGRAPH_URL: Record<number, string> = {
  [SupportedChainId.SEPOLIA]: 'https://api.thegraph.com/subgraphs/name/0xtarc/mock-uniswap-v3-sepolia',
...
const httpLink = new HttpLink({ uri: CHAIN_SUBGRAPH_URL[SupportedChainId.SEPOLIA] })
  ...
  operation.setContext(() => ({
    uri:
      chainId && CHAIN_SUBGRAPH_URL[chainId]
        ...
        : CHAIN_SUBGRAPH_URL[SupportedChainId.SEPOLIA],
  }))
